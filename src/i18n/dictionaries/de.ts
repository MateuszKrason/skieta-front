...
export const de: Record<string, string> = {
  ...
  'Tak. Przycisk „Zobacz demo" na górze strony otwiera przykładowe konto z budżetem, portfelem, celami oszczędnościowymi i samochodem - możesz wszystko przeklikać, tylko zmiany nie są zapisywane. Bez konta działa też kalkulator inwestycyjny.': 'Ja. Der Button „Demo ansehen“ oben auf der Seite öffnet ein Beispielkonto mit Budget, Portfolio, Sparzielen und Auto - du kannst dich überall durchklicken, nur Änderungen werden nicht gespeichert. Auch der Investitionsrechner funktioniert ohne Konto.',
