...
export const de: Record<string, string> = {
  ...
  'Odejmij tę kwotę z salda konta - zaznacz tylko wtedy, gdy przy zakupie konto zostało pominięte przez pomyłkę. Domyślnie zapisujemy samo powiązanie.': 'Diesen Betrag vom Kontostand abziehen - nur ankreuzen, wenn du beim Kauf vergessen hast, das Konto zu wählen. Standardmäßig speichern wir nur die Verknüpfung.',
  'Nie udało się odczytać sumy z paragonu - liczymy ją z pozycji poniżej. Sprawdź, czy się zgadza.': 'Die Summe auf dem Beleg war nicht lesbar - wir rechnen sie aus den Positionen unten zusammen. Prüfe, ob sie stimmt.',
  'Podziału dokonał prostszy model - warto sprawdzić pozycje.': 'Diesen Beleg hat ein einfacheres Modell aufgeteilt - die Positionen brauchen vielleicht Korrekturen.',
  'Dzienny limit mocniejszego modelu wyczerpany - paragon odczytany prościej, jedną kategorią. Spróbuj jutro.': 'Das Tageslimit des stärkeren Modells ist aufgebraucht - der Beleg wurde als eine Kategorie gelesen. Versuche es morgen wieder.',
  'Nie udało się rozbić tego paragonu na pozycje - odczytaliśmy go jedną kwotą. Spróbuj wyraźniejszego zdjęcia.': 'Dieser Beleg ließ sich nicht in Positionen zerlegen - wir haben ihn als einen Betrag gelesen. Versuche ein schärferes Foto.',
  'Klucz jest Twój i działa w oparciu o Twoje konto Google - to Google ustala darmowe limity i ewentualne opłaty po ich przekroczeniu, więc za rozliczenia po stronie Google nie odpowiadamy. Klucz trzymamy zaszyfrowany i usuniesz go stąd jednym kliknięciem.': 'Der Schlüssel gehört dir und läuft über dein eigenes Google-Konto - Google legt die kostenlosen Limits und mögliche Gebühren darüber hinaus fest, für die Abrechnung dort können wir also nicht einstehen. Wir speichern den Schlüssel verschlüsselt und du löschst ihn hier mit einem Klick.',
  'Szczegóły w regulaminie': 'Details in den Nutzungsbedingungen',
  'Skąd przyszły konta': 'Woher die Konten kamen',
  'Liczone przy rejestracji, nie przy kliknięciu - to konta, które faktycznie powstały.': 'Bei der Registrierung gezählt, nicht beim Klick - das sind tatsächlich entstandene Konten.',
  'Konta z artykułów': 'Konten aus Artikeln',
  'Który tekst realnie przyprowadził użytkownika, a nie tylko czytelnika.': 'Welcher Text wirklich einen Nutzer gebracht hat, nicht nur einen Leser.',
  'Strona główna (góra)': 'Startseite (oben)',
  'Strona główna (FAQ)': 'Startseite (FAQ)',
  'Artykuł': 'Artikel',
  'Kalkulator': 'Rechner',
  ...
  'Zaznacz kategorie, które chcesz porównywać - reszta na razie się schowa, żeby zacząć od czytelnego widoku zamiast dwudziestu wierszy naraz. Nic z tego nie jest ostateczne: pojedyncze wiersze nadal odznaczysz i dodasz poniżej.': 'Wähle die Kategorien, die du vergleichen möchtest - der Rest verschwindet vorerst, damit du mit einer übersichtlichen Ansicht statt zwanzig Zeilen auf einmal startest. Nichts davon ist endgültig: Du kannst einzelne Zeilen weiterhin ab- und weiter unten wieder anwählen.',
  'Pokaż wybrane': 'Ausgewählte anzeigen',
  'Pokaż mi wszystko': 'Zeig mir alles',
  'Zmień, co Cię interesuje': 'Ändern, was dich interessiert',
  'za rok {0}': 'für {0}',
  'dzień dywidendy {0}': 'Stichtag {0}',
  'wypłata {0}': 'Auszahlung {0}',
  'Dywidenda na akcję': 'Dividende je Aktie',
  'Najbliższe wyniki': 'Nächste Ergebnisse',
  'Walne zgromadzenie': 'Hauptversammlung',
  'Średnia cena docelowa': 'Durchschnittliches Kursziel',
  'Konsensus analityków': 'Analystenkonsens',
  'Najważniejsze dane': 'Wichtigste Kennzahlen',
  'Zapamiętane z Twoich analiz - każda wartość pochodzi z najnowszej analizy, która ją znalazła.': 'Aus deinen Analysen gespeichert - jeder Wert stammt aus der neuesten Analyse, die ihn gefunden hat.',
  'wg analizy z {0}': 'laut Analyse vom {0}',
  'Stan na {0}': 'Stand: {0}',
  'źródła: {0} (komunikaty spółki i wiadomości)': 'Quellen: {0} (Unternehmensmitteilungen und Nachrichten)',
  'nie znalazłem żadnych komunikatów ani wiadomości o tej spółce z tego okresu': 'für diesen Zeitraum wurden keine Mitteilungen oder Meldungen zu diesem Unternehmen gefunden',
  'Komunikaty ESPI/EBI': 'ESPI/EBI-Mitteilungen',
  'Pozostałe zebrane materiały, które nie weszły do podsumowania ({0})': 'Weitere gesammelte Materialien, die nicht in die Zusammenfassung eingeflossen sind ({0})',
  'Nic nowego w tym okresie.': 'Nichts Neues in diesem Zeitraum.',
  'Brak informacji.': 'Keine Informationen.',
  'Źródła ({0})': 'Quellen ({0})',
  'Ta spółka była już dziś sprawdzana ({0}). Każde sprawdzenie zużywa zapytanie z darmowego dziennego limitu Twojego klucza Gemini - tego samego, z którego korzysta skanowanie paragonów. Gdy się wyczerpie, oba działają dopiero po odnowieniu limitu, około 9:00 czasu polskiego. Na pewno sprawdzić jeszcze raz?': 'Dieses Unternehmen wurde heute bereits geprüft ({0}). Jede Prüfung verbraucht eine Anfrage aus dem kostenlosen Tageslimit deines Gemini-Schlüssels - demselben, den auch das Scannen von Kassenbons nutzt. Ist es aufgebraucht, funktionieren beide erst wieder nach dem Zurücksetzen des Limits, gegen 9:00 Uhr polnischer Zeit. Trotzdem erneut prüfen?',
  'Co dzieje się w wybranej spółce: nadchodzące daty, komunikaty, transakcje, wyniki, plotki, oczekiwania i rekomendacje analityków. skieta zbiera komunikaty spółki i wiadomości z serwisów finansowych, a Google Gemini streszcza je w punktach na Twoim własnym kluczu - przy każdym punkcie jest numer źródła.': 'Was beim ausgewählten Unternehmen passiert: anstehende Termine, Mitteilungen, Transaktionen, Ergebnisse, Gerüchte, Erwartungen und Analystenempfehlungen. skieta sammelt die Mitteilungen des Unternehmens und Finanznachrichten, und Google Gemini fasst sie mit deinem eigenen Schlüssel in Stichpunkten zusammen - bei jedem Punkt steht die Nummer der Quelle.',
  'To nie jest rekomendacja inwestycyjna. Podsumowanie pisze model językowy, który może się pomylić albo coś pominąć - zanim na jego podstawie cokolwiek zrobisz, sprawdź informację w źródle.': 'Dies ist keine Anlageempfehlung. Die Zusammenfassung schreibt ein Sprachmodell, das sich irren oder etwas übersehen kann - prüfe die Information in der Quelle, bevor du auf dieser Grundlage handelst.',
  'Nie masz jeszcze w portfelu żadnej spółki do przeanalizowania.': 'Du hast noch kein Unternehmen im Portfolio, das analysiert werden kann.',
  'Przejdź do portfela': 'Zum Portfolio',
  'Informacje z': 'Informationen von',
  'Ostatnio sprawdzane: {0}': 'Zuletzt geprüft: {0}',
  'Jeszcze nie sprawdzano': 'Noch nicht geprüft',
  'Analiza potrzebuje Twojego klucza Gemini': 'Die Analyse braucht deinen Gemini-Schlüssel',
  'Komunikaty i wiadomości o spółce streszcza Google Gemini, na Twoim własnym, darmowym kluczu - tym samym, którego używa skanowanie paragonów. Ustawisz go raz, w dwie minuty, bez karty płatniczej.': 'Mitteilungen und Meldungen zum Unternehmen fasst Google Gemini mit deinem eigenen, kostenlosen Schlüssel zusammen - demselben, den das Scannen von Kassenbons nutzt. Du richtest ihn einmal ein, in zwei Minuten, ohne Zahlungskarte.',
  'Zbieram komunikaty i wiadomości o spółce i przygotowuję podsumowanie… Zwykle trwa to do minuty - możesz w tym czasie przejść do innej zakładki.': 'Ich sammle Mitteilungen und Meldungen zum Unternehmen und bereite die Zusammenfassung vor… Das dauert meist bis zu einer Minute - du kannst währenddessen zu einem anderen Tab wechseln.',
  'Poniżej ostatnia udana analiza.': 'Unten siehst du die letzte erfolgreiche Analyse.',
  'Kliknij „Sprawdź teraz”, żeby przygotować pierwszą analizę tej spółki.': 'Klicke auf „Jetzt prüfen“, um die erste Analyse dieses Unternehmens zu erstellen.',
  'Dziś': 'Heute',
  'Ten tydzień': 'Diese Woche',
  'Najważniejsze nadchodzące daty': 'Wichtigste anstehende Termine',
  'Ważne transakcje': 'Wichtige Transaktionen',
  'Wyniki finansowe': 'Finanzergebnisse',
  'Plotki i niepotwierdzone doniesienia': 'Gerüchte und unbestätigte Berichte',
  'Oczekiwania wobec spółki': 'Erwartungen an das Unternehmen',
  'Rekomendacje analityków': 'Analystenempfehlungen',
  'Analiza spółki': 'Unternehmensanalyse',
  'Wyczerpał się darmowy dzienny limit zapytań Twojego klucza Gemini. Limit odnawia się codziennie około 9:00 czasu polskiego - wtedy spróbuj ponownie.': 'Das kostenlose Tageslimit deines Gemini-Schlüssels ist aufgebraucht. Es wird jeden Tag gegen 9:00 Uhr polnischer Zeit zurückgesetzt - versuche es dann erneut.',
  'Google odrzucił Twój klucz Gemini. Sprawdź go albo wklej nowy w ustawieniach konta.': 'Google hat deinen Gemini-Schlüssel abgelehnt. Prüfe ihn oder füge in den Kontoeinstellungen einen neuen ein.',
  'Nie ustawiono klucza Gemini.': 'Es ist kein Gemini-Schlüssel eingerichtet.',
  'Sprawdzanie trwało za długo i zostało przerwane. Spróbuj ponownie za chwilę.': 'Die Prüfung hat zu lange gedauert und wurde abgebrochen. Versuche es gleich noch einmal.',
  'Nie udało się przygotować analizy. Spróbuj ponownie za chwilę.': 'Die Analyse konnte nicht erstellt werden. Versuche es gleich noch einmal.',
  'rekomendacja zarządu': 'Vorschlag des Vorstands',
  'uchwalona przez walne zgromadzenie': 'von der Hauptversammlung beschlossen',
  'Wiadomości': 'Nachrichten',
  'Otwieram demo…': 'Demo wird geöffnet…',
  ...
  'Wyjdź z demo': 'Demo verlassen',
  'Wpłata co miesiąc': 'Monatliche Einzahlung',
  'Założona inflacja (% rocznie)': 'Angenommene Inflation (% pro Jahr)',
  'Wpłacisz łącznie {0}. Inflacja wycenia obligacje indeksowane od drugiego roku i przelicza wynik na dzisiejsze pieniądze - cel NBP to 2,5%.': 'Insgesamt zahlst du {0} ein. Die Inflation bestimmt ab dem zweiten Jahr die Verzinsung der inflationsgebundenen Anleihen und rechnet das Ergebnis in heutiges Geld um - das Ziel der NBP liegt bei 2,5%.',
  'Wartość realna (po inflacji)': 'Realer Wert (nach Inflation)',
  'Przywróć domyślną stawkę ({0}%)': 'Standardsatz wiederherstellen ({0}%)',
  'od 2. roku: {0}%': 'ab Jahr 2: {0}%',
  'Pierwszy rok: stałe oprocentowanie. Od drugiego roku: inflacja + marża {0}% - kalkulator liczy to z założonej inflacji, którą ustawiasz powyżej. Rzeczywisty wynik zależy od tego, jaka inflacja faktycznie będzie.': 'Erstes Jahr: fester Satz. Ab dem zweiten Jahr: Inflation + {0}% Marge - der Rechner ermittelt das aus der oben angenommenen Inflation. Das tatsächliche Ergebnis hängt davon ab, wie hoch die Inflation wirklich ausfällt.',
  'Odsetki z COI są wypłacane co roku - wynik zakłada, że je reinwestujesz.': 'Die Zinsen von COI werden jährlich ausgezahlt - das Ergebnis geht davon aus, dass du sie wieder anlegst.',
  'Wydatki w skiecie na telefonie, z przyciskiem skanowania paragonu w nagłówku': 'Ausgaben in skieta auf dem Handy, mit der Schaltfläche zum Scannen von Kassenbons in der Kopfzeile',
  'Raporty dla SEC': 'SEC-Berichte',
  'Komunikaty ESPI/EBI (GPW), raporty dla SEC i ważne newsy (USA) dla spółek z Twojego portfela - sprawdzane raz dziennie.': 'ESPI/EBI-Mitteilungen (GPW), SEC-Berichte und wichtige Nachrichten (USA) zu den Unternehmen in deinem Portfolio - einmal täglich geprüft.',
  'Podobne spółki': 'Ähnliche Unternehmen',
  'Spółki z tej samej branży zaproponowane przez model i sprawdzone w wyszukiwarce notowań - to nie jest rekomendacja.': 'Unternehmen derselben Branche, vom Modell vorgeschlagen und in der Kurssuche überprüft - das ist keine Empfehlung.',
  'Analizuj': 'Analysieren',
  'Dashboard skiety na telefonie': 'Das skieta-Dashboard auf dem Handy',
  'Sprawdzam komunikaty Twoich spółek - to może potrwać do minuty.': 'Prüfe Meldungen zu deinen Unternehmen - das kann bis zu einer Minute dauern.',
  'Nowych wiadomości: {0}': 'Neue Meldungen: {0}',
  'Tak. Przycisk „Zobacz demo" na górze strony otwiera przykładowe konto z budżetem, portfelem, celami oszczędnościowymi i samochodem. Dostajesz jego prywatną kopię: możesz dodawać, zmieniać i usuwać, nikt inny tego nie widzi, a kopia znika po 24 godzinach. Bez konta działa też kalkulator inwestycyjny.': 'Ja. Der Button „Demo ansehen“ oben auf der Seite öffnet ein Beispielkonto mit Budget, Portfolio, Sparzielen und Auto. Du bekommst eine private Kopie davon: Du kannst hinzufügen, ändern und löschen, niemand sonst sieht es, und die Kopie verschwindet nach 24 Stunden. Der Investitionsrechner funktioniert auch ohne Konto.',
  'Ta funkcja nie działa w wersji demo. Załóż własne konto, żeby z niej skorzystać.': 'Diese Funktion ist in der Demo deaktiviert. Erstelle ein eigenes Konto, um sie zu nutzen.',
