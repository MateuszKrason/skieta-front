...
export const no: Record<string, string> = {
  ...
  'Sprawdzam komunikaty Twoich spółek - to może potrwać do minuty.': 'Sjekker meldinger for selskapene dine - dette kan ta opptil ett minutt.',
  'Nowych wiadomości: {0}': 'Nye meldinger: {0}',
