...
export const sq: Record<string, string> = {
  ...
  'Sprawdzam komunikaty Twoich spółek - to może potrwać do minuty.': 'Po kontrolloj njoftimet e kompanive të tua - mund të zgjasë deri në një minutë.',
  'Nowych wiadomości: {0}': 'Njoftime të reja: {0}',
