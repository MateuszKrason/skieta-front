...
export const sq: Record<string, string> = {
  ...
  'Zwrócone': 'Kthyer',
  'Odejmij tę kwotę z salda konta - zaznacz tylko wtedy, gdy przy zakupie konto zostało pominięte przez pomyłkę. Domyślnie zapisujemy samo powiązanie.': 'Zbrite këtë shumë nga gjendja e llogarisë - shënoje vetëm nëse harrove të zgjedhësh llogarinë kur bleve. Si parazgjedhje ruajmë vetëm lidhjen.',
  'Nie udało się odczytać sumy z paragonu - liczymy ją z pozycji poniżej. Sprawdź, czy się zgadza.': 'Nuk arritëm ta lexojmë totalin e faturës, prandaj e mblodhëm nga artikujt më poshtë. Kontrollo nëse përputhet.',
  'Podziału dokonał prostszy model - warto sprawdzić pozycje.': 'Këtë faturë e ndau një model më i thjeshtë - artikujt mund të kenë nevojë për ndreqje.',
  'Dzienny limit mocniejszego modelu wyczerpany - paragon odczytany prościej, jedną kategorią. Spróbuj jutro.': 'Kuota ditore e modelit më të fuqishëm mbaroi - fatura u lexua si një kategori e vetme. Provo nesër.',
  'Nie udało się rozbić tego paragonu na pozycje - odczytaliśmy go jedną kwotą. Spróbuj wyraźniejszego zdjęcia.': 'Kjo faturë nuk u nda dot në artikuj, ndaj e lexuam si një shumë të vetme. Provo një foto më të qartë.',
  'Klucz jest Twój i działa w oparciu o Twoje konto Google - to Google ustala darmowe limity i ewentualne opłaty po ich przekroczeniu, więc za rozliczenia po stronie Google nie odpowiadamy. Klucz trzymamy zaszyfrowany i usuniesz go stąd jednym kliknięciem.': 'Çelësi është yti dhe punon në llogarinë tënde Google - Google i cakton kufijtë falas dhe tarifat e mundshme përtej tyre, prandaj për faturimin te ata nuk mund të përgjigjemi. Çelësin e ruajmë të enkriptuar dhe e fshin që këtu me një klikim.',
  'Szczegóły w regulaminie': 'Detajet te kushtet',
  'Skąd przyszły konta': 'Nga erdhën llogaritë',
  'Liczone przy rejestracji, nie przy kliknięciu - to konta, które faktycznie powstały.': 'Numëruar në regjistrim, jo në klikim - këto janë llogari që u krijuan vërtet.',
  'Konta z artykułów': 'Llogari nga artikujt',
  'Który tekst realnie przyprowadził użytkownika, a nie tylko czytelnika.': 'Cili tekst solli vërtet një përdorues, jo thjesht një lexues.',
  'Strona główna (góra)': 'Faqja kryesore (lart)',
  'Strona główna (FAQ)': 'Faqja kryesore (FAQ)',
  'Artykuł': 'Artikull',
  ...
  'Czym się interesujesz?': 'Çfarë të intereson?',
  'Zaznacz kategorie, które chcesz porównywać - reszta na razie się schowa, żeby zacząć od czytelnego widoku zamiast dwudziestu wierszy naraz. Nic z tego nie jest ostateczne: pojedyncze wiersze nadal odznaczysz i dodasz poniżej.': 'Zgjidh kategoritë që dëshiron të krahasosh - pjesa tjetër do të fshihet përkohësisht, që të nisësh me një pamje të qartë në vend të njëzet rreshtave njëherësh. Asgjë këtu nuk është përfundimtare: mund të heqësh ose shtosh rreshta të veçantë më poshtë.',
  'Pokaż wybrane': 'Trego të zgjedhurat',
  'Pokaż mi wszystko': 'Më trego gjithçka',
  'Zmień, co Cię interesuje': 'Ndrysho çfarë të intereson',
  'za rok {0}': 'për vitin {0}',
  'dzień dywidendy {0}': 'data e regjistrimit {0}',
  'wypłata {0}': 'pagesa {0}',
  'Dywidenda na akcję': 'Dividendi për aksion',
  'Najbliższe wyniki': 'Rezultatet e ardhshme',
  'Walne zgromadzenie': 'Asambleja e përgjithshme',
  'Średnia cena docelowa': 'Çmimi mesatar i synuar',
  'Konsensus analityków': 'Konsensusi i analistëve',
  'Najważniejsze dane': 'Të dhënat kryesore',
  'Zapamiętane z Twoich analiz - każda wartość pochodzi z najnowszej analizy, która ją znalazła.': 'Ruajtur nga analizat e tua - çdo vlerë vjen nga analiza më e fundit që e gjeti.',
  'wg analizy z {0}': 'sipas analizës së {0}',
  'Stan na {0}': 'Gjendja më {0}',
  'źródła: {0} (komunikaty spółki i wiadomości)': 'burime: {0} (njoftime të kompanisë dhe lajme)',
  'nie znalazłem żadnych komunikatów ani wiadomości o tej spółce z tego okresu': 'nuk u gjetën njoftime apo lajme për këtë kompani në këtë periudhë',
  'Komunikaty ESPI/EBI': 'Njoftimet ESPI/EBI',
  'Pozostałe zebrane materiały, które nie weszły do podsumowania ({0})': 'Materiale të tjera të mbledhura që nuk hynë në përmbledhje ({0})',
  'Nic nowego w tym okresie.': 'Asgjë e re në këtë periudhë.',
  'Brak informacji.': 'Nuk ka informacion.',
  'Źródła ({0})': 'Burimet ({0})',
  'Ta spółka była już dziś sprawdzana ({0}). Każde sprawdzenie zużywa zapytanie z darmowego dziennego limitu Twojego klucza Gemini - tego samego, z którego korzysta skanowanie paragonów. Gdy się wyczerpie, oba działają dopiero po odnowieniu limitu, około 9:00 czasu polskiego. Na pewno sprawdzić jeszcze raz?': 'Kjo kompani është kontrolluar tashmë sot ({0}). Çdo kontroll përdor një kërkesë nga limiti ditor falas i çelësit tënd Gemini - i njëjti që përdor skanimi i faturave. Kur mbaron, të dyja funksionojnë sërish vetëm pasi limiti rinovohet, rreth orës 9:00 me orën e Polonisë. Të kontrollohet përsëri?',
  'Co dzieje się w wybranej spółce: nadchodzące daty, komunikaty, transakcje, wyniki, plotki, oczekiwania i rekomendacje analityków. skieta zbiera komunikaty spółki i wiadomości z serwisów finansowych, a Google Gemini streszcza je w punktach na Twoim własnym kluczu - przy każdym punkcie jest numer źródła.': 'Çfarë po ndodh në kompaninë e zgjedhur: data të ardhshme, njoftime, transaksione, rezultate, thashetheme, pritshmëri dhe rekomandime të analistëve. skieta mbledh njoftimet e kompanisë dhe lajmet financiare, ndërsa Google Gemini i përmbledh në pika me çelësin tënd - pranë çdo pike është numri i burimit.',
  'To nie jest rekomendacja inwestycyjna. Podsumowanie pisze model językowy, który może się pomylić albo coś pominąć - zanim na jego podstawie cokolwiek zrobisz, sprawdź informację w źródle.': 'Ky nuk është rekomandim investimi. Përmbledhjen e shkruan një model gjuhësor që mund të gabojë ose të lërë diçka jashtë - para se të veprosh, kontrollo informacionin në burim.',
  'Nie masz jeszcze w portfelu żadnej spółki do przeanalizowania.': 'Ende nuk ke asnjë kompani në portofol për të analizuar.',
  'Przejdź do portfela': 'Shko te portofoli',
  'Informacje z': 'Informacione nga',
  'Ostatnio sprawdzane: {0}': 'Kontrolluar së fundi: {0}',
  'Jeszcze nie sprawdzano': 'Ende e pakontrolluar',
  'Analiza potrzebuje Twojego klucza Gemini': 'Analiza ka nevojë për çelësin tënd Gemini',
  'Komunikaty i wiadomości o spółce streszcza Google Gemini, na Twoim własnym, darmowym kluczu - tym samym, którego używa skanowanie paragonów. Ustawisz go raz, w dwie minuty, bez karty płatniczej.': 'Njoftimet dhe lajmet për kompaninë i përmbledh Google Gemini me çelësin tënd falas - të njëjtin që përdor skanimi i faturave. E konfiguron një herë, për dy minuta, pa kartë pagese.',
  'Zbieram komunikaty i wiadomości o spółce i przygotowuję podsumowanie… Zwykle trwa to do minuty - możesz w tym czasie przejść do innej zakładki.': 'Po mbledh njoftimet dhe lajmet e kompanisë dhe po përgatis përmbledhjen… Zakonisht zgjat deri në një minutë - ndërkohë mund të kalosh në një skedë tjetër.',
  'Poniżej ostatnia udana analiza.': 'Më poshtë është analiza e fundit e suksesshme.',
  'Kliknij „Sprawdź teraz”, żeby przygotować pierwszą analizę tej spółki.': 'Kliko "Kontrollo tani" për të përgatitur analizën e parë të kësaj kompanie.',
  'Dziś': 'Sot',
  'Ten tydzień': 'Këtë javë',
  'Najważniejsze nadchodzące daty': 'Datat më të rëndësishme në vijim',
  'Ważne transakcje': 'Transaksione të rëndësishme',
  'Wyniki finansowe': 'Rezultatet financiare',
  'Plotki i niepotwierdzone doniesienia': 'Thashetheme dhe lajme të pakonfirmuara',
  'Oczekiwania wobec spółki': 'Pritshmëritë për kompaninë',
  'Rekomendacje analityków': 'Rekomandimet e analistëve',
  'Analiza spółki': 'Analiza e kompanisë',
  'Wyczerpał się darmowy dzienny limit zapytań Twojego klucza Gemini. Limit odnawia się codziennie około 9:00 czasu polskiego - wtedy spróbuj ponownie.': 'Limiti ditor falas i kërkesave të çelësit tënd Gemini ka mbaruar. Rinovohet çdo ditë rreth orës 9:00 me orën e Polonisë - provo sërish atëherë.',
  'Google odrzucił Twój klucz Gemini. Sprawdź go albo wklej nowy w ustawieniach konta.': 'Google e refuzoi çelësin tënd Gemini. Kontrolloje ose ngjit një të ri te cilësimet e llogarisë.',
  'Nie ustawiono klucza Gemini.': 'Nuk është vendosur çelës Gemini.',
  'Sprawdzanie trwało za długo i zostało przerwane. Spróbuj ponownie za chwilę.': 'Kontrolli zgjati shumë dhe u ndërpre. Provo sërish pas pak.',
  'Nie udało się przygotować analizy. Spróbuj ponownie za chwilę.': 'Analiza nuk mund të përgatitej. Provo sërish pas pak.',
  'rekomendacja zarządu': 'propozim i drejtimit',
  'uchwalona przez walne zgromadzenie': 'miratuar nga asambleja e përgjithshme',
  'Wiadomości': 'Lajme',
  'Otwieram demo…': 'Po hap demon…',
  ...
  'Tak. Przycisk „Zobacz demo" na górze strony otwiera przykładowe konto z budżetem, portfelem, celami oszczędnościowymi i samochodem - możesz wszystko przeklikać, tylko zmiany nie są zapisywane. Bez konta działa też kalkulator inwestycyjny.': 'Po. Butoni “Shiko demon” në krye të faqes hap një llogari shembull me buxhet, portofol, synime kursimi dhe makinë - mund t’i shfletosh të gjitha, vetëm ndryshimet nuk ruhen. Edhe kalkulatori i investimeve funksionon pa llogari.',
  ...
  'Wyjdź z demo': 'Dil nga demoja',
  'Wpłata co miesiąc': 'Derdhja mujore',
  'Założona inflacja (% rocznie)': 'Inflacioni i supozuar (% në vit)',
  'Wpłacisz łącznie {0}. Inflacja wycenia obligacje indeksowane od drugiego roku i przelicza wynik na dzisiejsze pieniądze - cel NBP to 2,5%.': 'Gjithsej do të derdhësh {0}. Inflacioni përcakton interesin e obligacioneve të indeksuara nga viti i dytë dhe e kthen rezultatin në paratë e sotme - objektivi i NBP-së është 2,5%.',
  'Wartość realna (po inflacji)': 'Vlera reale (pas inflacionit)',
  'Przywróć domyślną stawkę ({0}%)': 'Rikthe normën e paracaktuar ({0}%)',
  'od 2. roku: {0}%': 'nga viti i 2-të: {0}%',
  'Pierwszy rok: stałe oprocentowanie. Od drugiego roku: inflacja + marża {0}% - kalkulator liczy to z założonej inflacji, którą ustawiasz powyżej. Rzeczywisty wynik zależy od tego, jaka inflacja faktycznie będzie.': 'Viti i parë: normë fikse. Nga viti i dytë: inflacioni + marzh {0}% - kalkulatori e llogarit nga inflacioni që supozon më sipër. Rezultati real varet nga sa do të jetë vërtet inflacioni.',
  'Odsetki z COI są wypłacane co roku - wynik zakłada, że je reinwestujesz.': 'Interesi i COI paguhet çdo vit - rezultati supozon që e riinvestosh.',
  'Wydatki w skiecie na telefonie, z przyciskiem skanowania paragonu w nagłówku': 'Shpenzimet në skieta në telefon, me butonin e skanimit të faturës në krye',
  'Raporty dla SEC': 'Raportet për SEC',
  'Komunikaty ESPI/EBI (GPW), raporty dla SEC i ważne newsy (USA) dla spółek z Twojego portfela - sprawdzane raz dziennie.': 'Njoftimet ESPI/EBI (GPW), raportet për SEC dhe lajmet e rëndësishme (SHBA) për kompanitë në portofolin tënd - kontrollohen një herë në ditë.',
  'Podobne spółki': 'Kompani të ngjashme',
  'Spółki z tej samej branży zaproponowane przez model i sprawdzone w wyszukiwarce notowań - to nie jest rekomendacja.': 'Kompani nga e njëjta industri, të sugjeruara nga modeli dhe të kontrolluara në kërkimin e kuotimeve - ky nuk është rekomandim.',
  'Analizuj': 'Analizo',
  'Dashboard skiety na telefonie': 'Paneli i skieta-s në telefon',
  ...
  'Kwota na start': 'Shuma fillestare',
