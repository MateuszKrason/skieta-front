...
export const es: Record<string, string> = {
  ...
  'Sprawdzam komunikaty Twoich spółek - to może potrwać do minuty.': 'Comprobando los comunicados de tus empresas; puede tardar hasta un minuto.',
  'Nowych wiadomości: {0}': 'Noticias nuevas: {0}',
