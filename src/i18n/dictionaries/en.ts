...
export const en: Record<string, string> = {
  ...
  'Sprawdzam komunikaty Twoich spółek - to może potrwać do minuty.': 'Checking filings for your companies - this can take up to a minute.',
  'Nowych wiadomości: {0}': 'New items: {0}',
